...
/** Current explicit allow-list, used by the owner picker. */
...
/**
 * Replace the flow's explicit collaborator allow-list. Merely sharing a
 * workspace never exposes a flow; only selected active members gain access.
 */
