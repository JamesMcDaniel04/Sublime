...
function withN8nCodeShim(code: string): string {
  return [
    ...
    '  // $itemMatching approximated by index — the n8n default pairing for linear',
    '  // chains. Explicit multi-source pairing metadata is not tracked here.',
    '  const $itemMatching = (i) => items[i] ?? { json: undefined }',
