...
const STEP_TYPES = ['agent', 'code', 'condition', 'loop', 'parallel', 'stop', 'tool', 'http', 'transform', 'filter', 'switch', 'variable', 'data', 'humanReview'] as const satisfies readonly StepType[]
