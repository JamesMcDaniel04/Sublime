...
function localLogo(slug: string): string | undefined {
  ...
  // Custom Den MCP connections slugify to den_mcp / denmcp /
  // "den mcp" etc.; any variant containing "den" gets the mark.
  if (key.includes('den')) return LOCAL_LOGOS.den
