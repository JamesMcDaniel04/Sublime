...
function ExplorePage() {
  ...
  // shared community library, in their own "Your library" section.
  const myTemplates = filteredTemplates.filter((t) => t.mine)
  const communityTemplates = filteredTemplates.filter((t) => !t.mine)
          ...
          <CardHeader className="space-y-2.5 pt-5">
            <div className="flex items-center gap-1.5">
              ...
              {t.autoGenerated ? (
                ...
                <Badge variant="outline" className="text-[11px] font-medium border-indigo-200 bg-indigo-50 text-indigo-700 dark:border-indigo-500/30 dark:bg-indigo-500/10 dark:text-indigo-300">Community</Badge>
              )}
            </div>
